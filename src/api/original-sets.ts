...
export interface OriginalSetBase {
...
export interface OriginalSetSummary extends OriginalSetBase {
...
export async function createOriginalSet(input: { designId: string; notes?: string }): Promise<OriginalSetBase> { return (await apiClient.post<OriginalSetBase>('/api/original-sets', input)).data }
...
export async function verifyOriginalSet(originalSetId: string): Promise<OriginalSetBase> { return (await apiClient.post<OriginalSetBase>(`/api/original-sets/${originalSetId}/verify`)).data }
