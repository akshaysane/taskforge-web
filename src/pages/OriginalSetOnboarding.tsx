...
function pieceComplete(detail: OriginalSetDetail, item: InventoryItem) {
  return requiredDefinitions(detail, item).every((definition) => item.measurements.some((measurement) => measurement.measurementDefinitionId === definition.id))
}
