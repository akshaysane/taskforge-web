...
const router = createBrowserRouter(createRoutesFromElements(<Route element={<AppBootstrap />}>
  ...
  <Route element={<ProtectedRoute />}><Route element={<AppShell />}>
    ...
    <Route path="/scan" element={<Suspense fallback={<LoadingState label="Loading scanner" />}><Scan /></Suspense>} /><Route path="/inventory/items/:inventoryItemId" element={<Suspense fallback={<LoadingState label="Loading inventory item" />}><InventoryDetail /></Suspense>} /><Route path="/inventory/:inventoryCode" element={<Suspense fallback={<LoadingState label="Loading inventory item" />}><InventoryDetail /></Suspense>} />
